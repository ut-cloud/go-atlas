...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	baseSecurityRepo := data.NewBaseSecurityRepo(dataData, logger)
	baseSecurityUsecase := biz.NewBaseSecurityUsecase(baseSecurityRepo, logger)
	authUsecase := biz.NewAuthUsecase(sysMenuRepo, sysUserUsecase, sysRoleUsecase, coreUsecase, baseSecurityUsecase, logger)
	sysMenuUsecase := biz.NewSysMenuUsecase(sysMenuRepo, sysRoleRepo, logger)
	authService := service.NewAuthService(authUsecase, sysUserUsecase, sysRoleUsecase, sysMenuUsecase, logger)
