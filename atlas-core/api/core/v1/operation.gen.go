...
func GetAllOperations() []string {
	return []string{
		OperationAuthCaptcha,                //"/api.core.v1.Auth/Captcha"Ω
		OperationAuthLogin,                  //"/api.core.v1.Auth/Login"Ω
		OperationAuthLogout,                 //"/api.core.v1.Auth/Logout"Ω
		OperationAuthRegister,               //"/api.core.v1.Auth/Register"Ω
		OperationAuthRouters,                //"/api.core.v1.Auth/Routers"Ω
		OperationAuthUserInfo,               //"/api.core.v1.Auth/UserInfo"Ω
		...
		OperationSysDictSysDictDataType,     //"/api.core.v1.SysDict/SysDictDataType"Ω
		...
		OperationSysUserProfile,             //"/api.core.v1.SysUser/Profile"Ω
		OperationSysUserResetPwd,            //"/api.core.v1.SysUser/ResetPwd"@
		OperationSysUserSaveSysUser,         //"/api.core.v1.SysUser/SaveSysUser"@
		OperationSysUserUpdatePassword,      //"/api.core.v1.SysUser/UpdatePassword"Ω
		OperationSysUserUpdateProfile,       //"/api.core.v1.SysUser/UpdateProfile"Ω
		...
		OperationSysConfigConfigByKey,       //"/api.core.v1.SysConfig/ConfigByKey"Ω
